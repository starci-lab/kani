/* 
 * Webpack configuration for kani-observer (NestJS application)
 * 
...
/**
 * Base package.json template for kani-observer
 * This file will be generated inside dist/apps/kani-observer
 */
const basePackage = {
    name: "kani-observer",
    version: "0.0.1",
     ...
     * IMPORTANT:
     * - package.json is generated inside dist/apps/kani-observer
    ...
    /**
     * Dependencies for the observer application
     */
    dependencies: {
...
module.exports = {
    /**
     * TypeScript entry point for the observer application
     */
    entry: "./apps/kani-observer/src/main.ts",

    /**
     * Output bundle location
     * Final result: dist/apps/kani-observer/main.js
     */
    output: {
        path: path.join(__dirname, "../..", "dist", "apps", "kani-observer"),
        filename: "main.js",
    },
