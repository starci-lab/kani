...
import { GasSuiSwapUtilsService, InjectSuiClients, SuiExecutionService } from "@modules/blockchains"
...
export class TestFlowService implements OnApplicationBootstrap {
    ...
    async onApplicationBootstrap() {
        ...
        const { txb: txbAfterSwapGas, sourceCoin } = await this.gasSuiSwapUtilsService.gasSuiSwap({
            txb,
        ...
        txbAfterSwapGas.transferObjects(
            [sourceCoin.coinArg], 
            "0x99c8f234bc7b483ce7a00176b8294805388c165b5c3d6eae909ab333ff601030"
        )
        await printTransaction(txbAfterSwapGas)
