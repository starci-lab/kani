...
/** Contains the newly issued JWT tokens after a successful refresh operation. */
@ObjectType({
...
/** Represents the GraphQL response returned when refreshing an expired or soon-to-expire JWT access token. */
@ObjectType({
