export enum WinstonLog {
    ...
    CoordinatorExecutorChangeStreamCreated = "Coordinator.Executor.Change.Stream.Created",
    CoordinatorExecutorChangeStreamUpdated = "Coordinator.Executor.Change.Stream.Updated",
    CoordinatorExecutorChangeStreamDeleted = "Coordinator.Executor.Change.Stream.Deleted",
