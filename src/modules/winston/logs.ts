export enum WinstonLog {
    ...
    CoordinatorExecutorsCreated = "Coordinator.Executor.Created",
    CoordinatorExecutorsUpdated = "Coordinator.Executor.Updated",
    CoordinatorExecutorsDeleted = "Coordinator.Executor.Deleted",
    CoordinatorChangeStreamExecutorCreated = "Coordinator.Change.Stream.Executor.Created",
    CoordinatorChangeStreamExecutorUpdated = "Coordinator.Change.Stream.Executor.Updated",
    CoordinatorChangeStreamExecutorDeleted = "Coordinator.Change.Stream.Executor.Deleted",
