export enum WinstonLog {
    ...
    ReconcileBalanceJobFailedFatal = "Reconcile.Balance.Job.Failed.Fatal",
    ...
    WithdrawJobFailedFatal = "Withdraw.Job.Failed.Fatal",
    ...
    ClosePositionJobFailedFatal = "Close.Position.Job.Failed.Fatal",
    ...
    OpenPositionJobFailedFatal = "Open.Position.Job.Failed.Fatal",
