export enum WinstonLog {
    ...
    WithdrawEnqueued = "Withdraw.Enqueued",
    WithdrawEnqueueFailed = "Withdraw.Enqueue.Failed",
    WithdrawProcessingFailedUnrecoverable = "Withdraw.Processing.Failed.Unrecoverable",
    WithdrawProcessingFailedPermanentFailure = "Withdraw.Processing.Failed.Permanent.Failure",
    WithdrawProcessingFailedRetryable = "Withdraw.Processing.Failed.Retryable",
    WithdrawProcessingCompleted = "Withdraw.Processing.Completed",
    WithdrawProcessingStarted = "Withdraw.Processing.Started",
